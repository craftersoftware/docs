...
.. list-table::
    ...
    * - publish_cancel
      - User is permitted to cancel a publish request from the :ref:`UI <publishing-and-status>`
        or via the API :base_url:`Cancel publish packages <_static/api/studio.html#tag/workflow/operation/cancelPublishPackages>`
    ...
    * - publish_get_queue
      - User is permitted to get the list of packages in the publishing queue from the :ref:`UI <publishing-and-status>`
        ...
        - :base_url:`Get publish package items <_static/api/studio.html#tag/publishing/operation/getPublishPackageItems>`
        - :base_url:`Get workflow affected packages <_static/api/studio.html#tag/workflow/operation/getWorkflowAffectedPackages>`
