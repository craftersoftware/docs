...
----------------------------------------------------
CrafterCMS Version 4.4.1 and 4.4.1E |enterpriseOnly|
----------------------------------------------------
...
* `Fixed issue with template names getting lowercased when opening the template editor from the content type or an
  item's options menu <https://github.com/craftersoftware/craftercms/issues/8027>`__
* `Fixed issue with Preview failing to reload to reflect changes after editing content <https://github.com/craftersoftware/craftercms/issues/8223>`__
