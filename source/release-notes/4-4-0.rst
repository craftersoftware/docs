...
----------------------------------------------------
CrafterCMS Version 4.4.0 and 4.4.0E |enterpriseOnly|
----------------------------------------------------
...
Bug Fixes
^^^^^^^^^
* `Fixed issue with modifying page URL not reloading the page URL on Save & Close <https://github.com/craftersoftware/craftercms/issues/7870>`__
* `Fixed issue with image cropper dialog <https://github.com/craftersoftware/craftercms/issues/7985>`__
* `Fixed issue with inserting links to pages in the RTE <https://github.com/craftersoftware/craftercms/issues/7987>`__
* `Fixed issue with initial publish failing when .keep files exist under the /.crafter folder <https://github.com/craftersoftware/craftercms/issues/8093>`__
* `Fixed issue with site breaking when duplicating an item <https://github.com/craftersoftware/craftercms/issues/8154>`__
