...
----------------------------------------------------
CrafterCMS Version 4.4.3 and 4.4.3E |enterpriseOnly|
----------------------------------------------------
...
New Features
^^^^^^^^^^^^
* `New Crafter Studio full disk monitoring <https://github.com/craftersoftware/craftercms/issues/8272>`__ |br|
...
* `Smart Git in Git HTTPS server is now supported <https://github.com/craftersoftware/craftercms/issues/8268>`__ |br|
...
* `Item Selector now shows view options for file types with preview support <https://github.com/craftersoftware/craftercms/issues/8308>`__ |br|
