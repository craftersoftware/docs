...
* **New v2 Studio APIs**
  ...
  - Sites
    ...
    - :base_url:`Create a site <_static/api/studio.html#tag/sites/operation/createSite>`: POST /api/2/sites
  ...
  - Content
    ...
    - :base_url:`Upload file <_static/api/studio.html#tag/content/operation/contentUpload>`: PUT /api/2/content/{siteId}
    - :base_url:`Get the existing items order for a given parent path <_static/api/studio.html#tag/content/operation/getItemsOrder>`: PUT /api/2/content/{siteId}/order
    - :base_url:`Calculates the order value so the item is placed at the selected location <_static/api/studio.html#tag/content/operation/reorderItem>`: PUT /api/2/content/{siteId}/order/reorder

  - contentTypes

    - :base_url:`Get all usage of a given content-type <_static/api/studio.html#tag/contentTypes/operation/getContentTypeUsage>`: GET /api/2/configuration/content_types/{siteId}/usage
    - :base_url:`Get content type configuration file for a given content type <_static/api/studio.html#tag/contentTypes/operation/getContentTypeConfiguration>`: GET /api/2/configuration/content_types/{siteId}
    - :base_url:`Delete files related to a given content-type <_static/api/studio.html#tag/contentTypes/operation/deleteContentType>`: DELETE /api/2/configuration/content_types/{siteId}
    - :base_url:`Get allowed content types for a given site at a given path <_static/api/studio.html#tag/contentTypes/operation/getAllowedContentTypes>`: GET /api/2/configuration/content_types/{siteId}/allowed_types
    - :base_url:`Get preview image of a given content type <_static/api/studio.html#tag/contentTypes/operation/getContentTypePreviewImage>`: GET /api/2/configuration/content_types/{siteId}/preview_image
    - :base_url:`Get the form controller (if it exists) script of a given content type <_static/api/studio.html#tag/contentTypes/operation/getContentTypeFormController>`: GET /api/2/configuration/content_types/{siteId}/form_controller
  ...
  - System
    ...
    - :base_url:`Get available languages <_static/api/studio.html#tag/system/operation/getAvailableLanguages>`: GET /api/2/system/available_languages
...
* To get the content of an item, please use the :base_url:`Get item <_static/api/engine.html#tag/content/operation/getItem>` API. |br|
  `The deprecated Engine REST API Get Descriptor /api/1/site/content_store/descriptor is now removed <https://github.com/craftercms/craftercms/issues/8294>`__.
...
- [hooks]
  ...
  - [services]
    ...
    - Removed ``workflow/publish`` and ``workflow/requestPublish``, replaced by ``publishing/publish``.
...
* Noteworthy dependency updates:
  ...
  - Groovy to version 5
  - MariaDB to version 11.8
  - MariaDB4j to version 3.3
