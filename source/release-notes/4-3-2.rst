...
----------------------------------------------------
CrafterCMS Version 4.3.2 and 4.3.2E |enterpriseOnly|
----------------------------------------------------
...
Enhancements
^^^^^^^^^^^^
* `Improved Docker images <https://github.com/craftersoftware/craftercms/issues/7913>`__
...
Bug Fixes
^^^^^^^^^
* `Fixed issue with docker compose deployments <https://github.com/craftersoftware/craftercms/issues/7939>`__
