...
----------------------------------------------------
CrafterCMS Version 4.2.2 and 4.2.2E |enterpriseOnly|
----------------------------------------------------
...
Enhancements
^^^^^^^^^^^^
* `Deployer processors improvements <https://github.com/craftersoftware/craftercms/issues/7617>`__
...
Bug Fixes
^^^^^^^^^
* `Fixed issue with deleting and recreating an item with the same name and page URL <https://github.com/craftersoftware/craftercms/issues/7608>`__
* `Fixed issue with existing component drag and drop not working when XB is enabled <https://github.com/craftersoftware/craftercms/issues/7656>`__
* `Fixed issue with AWS SSO authentication <https://github.com/craftersoftware/craftercms/issues/7663>`__
